...
export const planDetails: Record<SubscriptionPlan, PlanDetails> = {
  ...
  COMPLETE: {
    ...
    label: "Premium",
    priceCents: 49990,
    pricePerExtraUserCents: 790,
    price: "R$499,90",
    pricePerExtraUser: "R$7,90",
    includedUsers: 60,
    maxUsers: null,
    ...
    features: [
      ...
      "Usuarios extras por R$7,90/mes cada",
...
export const planDifferences = [
  ...
  },
  {
    ...
    BASIC: "R$11,90 por usuario/mes",
    MANAGEMENT: "R$9,90 por usuario/mes",
    COMPLETE: "R$7,90 por usuario/mes",
  },
  {
